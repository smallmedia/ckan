...
from ckanext.infographic.logic.validators import (
    convert_package_name_or_id_to_id_for_type_dataset,
    convert_package_name_or_id_to_id_for_type_infographic)


def infographic_base_schema():
    schema = {
        'id': [empty],
        'revision_id': [ignore],
...
def infographic_create_schema():
    return infographic_base_schema()


def infographic_update_schema():
    schema = infographic_base_schema()
...
def infographic_package_association_create_schema():
    schema = {
        'package_id': [not_empty, unicode,
                       convert_package_name_or_id_to_id_for_type_dataset],
        'infographic_id': [not_empty, unicode,
                        convert_package_name_or_id_to_id_for_type_infographic]
    }
    return schema


def infographic_package_association_delete_schema():
    return infographic_package_association_create_schema()


def infographic_package_list_schema():
    schema = {
        'infographic_id': [not_empty, unicode,
                        convert_package_name_or_id_to_id_for_type_infographic]
    }
...
def package_infographic_list_schema():
    schema = {
        'package_id': [not_empty, unicode,
                       convert_package_name_or_id_to_id_for_type_dataset]
    }
...
def infographic_admin_add_schema():
    schema = {
...
def infographic_admin_remove_schema():
    return infographic_admin_add_schema()
