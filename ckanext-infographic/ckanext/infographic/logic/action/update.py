...
def infographic_update(context, data_dict):
    ...
    try:
        upload = uploader.get_uploader('infographic', data_dict['image_url'])
    except AttributeError:
        upload = uploader.Upload('infographic', data_dict['image_url'])
