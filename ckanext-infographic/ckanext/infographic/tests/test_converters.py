...
from ckanext.infographic.logic.converters import convert_package_name_or_id_to_title_or_name
from ckanext.infographic.tests import InfographicFunctionalTestBase


class TestNameOrIdToTitleConverter(InfographicFunctionalTestBase):
