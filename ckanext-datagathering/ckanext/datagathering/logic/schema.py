...
from ckanext.datagathering.logic.validators import (
    convert_package_name_or_id_to_id_for_type_dataset,
    convert_package_name_or_id_to_id_for_type_datagathering)


def datagathering_base_schema():
    schema = {
        'id': [empty],
        'revision_id': [ignore],
...
def datagathering_create_schema():
    return datagathering_base_schema()


def datagathering_update_schema():
    schema = datagathering_base_schema()
...
def datagathering_package_association_create_schema():
    schema = {
        'package_id': [not_empty, unicode,
                       convert_package_name_or_id_to_id_for_type_dataset],
        'datagathering_id': [not_empty, unicode,
                        convert_package_name_or_id_to_id_for_type_datagathering]
    }
    return schema


def datagathering_package_association_delete_schema():
    return datagathering_package_association_create_schema()


def datagathering_package_list_schema():
    schema = {
        'datagathering_id': [not_empty, unicode,
                        convert_package_name_or_id_to_id_for_type_datagathering]
    }
...
def package_datagathering_list_schema():
    schema = {
        'package_id': [not_empty, unicode,
                       convert_package_name_or_id_to_id_for_type_dataset]
    }
...
def datagathering_admin_add_schema():
    schema = {
...
def datagathering_admin_remove_schema():
    return datagathering_admin_add_schema()
