...
def datagathering_update(context, data_dict):
    ...
    try:
        upload = uploader.get_uploader('datagathering', data_dict['image_url'])
    except AttributeError:
        upload = uploader.Upload('datagathering', data_dict['image_url'])
